...
export async function POST(req: Request) {
  try {
    ...
    - Certificate of Merit – Product Matters 6.0: Desc: Awarded for achieving a strong percentile and successfully completing Product Matters 6.0, demonstrating understanding of product management, creativity, and problem-solving skills. [Issuer: E-Cell, IIT Guwahati, Date: Aug 2026]
    ...
    - Communication Skills (Issued by YuWaah (Generation Unlimited) – UNICEF, July 2026): Completed with a perfect score of 100%, demonstrating proficiency in effective interpersonal and professional communication.
