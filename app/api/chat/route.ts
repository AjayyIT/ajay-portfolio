...
export async function POST(req: Request) {
  try {
    ...
    4. HIGHLIGHTS: If asked about skills or certificates, list only the top 3 most relevant ones instead of dumping all 20 at once.

    PERSONAL INFO, CHARACTER & LIFESTYLE:
    - Name: Ajay R S
    - Date of Birth: 27-08-2005
    ...
    - Relationship Status: Single. He is currently heavily prioritizing his B.Tech degree, upskilling in enterprise tech, and building his career.
    ...
    20 CERTIFICATIONS (Only list 2 or 3 if asked, unless they ask for all):
