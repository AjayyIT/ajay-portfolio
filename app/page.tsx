...
const certifications = [
  ...
  { title: "Certificate of Merit – Product Matters 6.0", issuer: "E-Cell, IIT Guwahati", date: "Aug 2026", img: "/certificates/pro-mat.png", desc: "Awarded for achieving a strong percentile and successfully completing Product Matters 6.0, demonstrating understanding of product management, creativity, and problem-solving skills."},
  ...
  { title: "Communication Skills", issuer: "YuWaah (Generation Unlimited) – UNICEF", date: "28 Jul 2026", img: "/certificates/communication skills.jpg", desc: "Successfully completed the Communication Skills course offered by Passport to Earning (P2E) with a perfect score of 100%, gaining essential interpersonal and professional communication skills required for workplace success." },
    ...
    <div style={themeStyles} className="min-h-screen bg-[var(--bg-base-light)] dark:bg-[var(--bg-main)] text-[var(--text-main-light)] dark:text-slate-100 font-sans selection:bg-[var(--c-primary)] selection:text-[var(--btn-text)] transition-colors duration-300">
      ...
      <section className="py-16 px-6 bg-[var(--c-primary)] dark:bg-[var(--bg-main)] text-[var(--btn-text)] dark:text-white border-y border-[var(--c-primary-text)] dark:border-[var(--border-dark)] transition-colors duration-300">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div><div className="text-3xl font-bold mb-2 dark:text-[var(--c-primary)]">25+</div><div className="dark:text-slate-400 text-xs font-medium uppercase tracking-wide opacity-80 dark:opacity-100">Certifications</div></div>
